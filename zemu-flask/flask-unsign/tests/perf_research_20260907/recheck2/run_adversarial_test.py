__file__ = 'D:\\CTFtool\\ZM\\zemu-flask\\flask-unsign\\tests\\adversarial_test.py'
"""对抗性测试:专挑边界与套件没覆盖的角落。"""
...
TOOL = 'D:\\CTFtool\\ZM\\zemu-flask\\flask-unsign\\tests\\perf_research_20260907\\recheck2\\zemu-flask.exe'
